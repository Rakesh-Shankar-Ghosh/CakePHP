...
//********This File is like kind of server.js coz this invoke each time the server runs**rakesh */

require_once __DIR__ . '/../src/Helper/DbConnectionTest.php'; // Adjust the path accordingly
Testconnection();
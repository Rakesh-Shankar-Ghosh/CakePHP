...
return [
    ...
    'Datasources' => [
        ...
        'default' => [
            ...
            'driver' => Postgres::class, // Use the Postgres driver
            'persistent' => false,
            'host' => env('DB_HOST'), // usually 'localhost'
            'port' => 5432, // PostgreSQL default port
            // 'username' => 'postgres', // Your PostgreSQL username
            // 'password' => 'django', // Your PostgreSQL password
            // 'database' => 'Cake', // Your PostgreSQL database name
            'timezone' => 'UTC',
            'flags' => [],
            'cacheMetadata' => true,
            'log' => false,
